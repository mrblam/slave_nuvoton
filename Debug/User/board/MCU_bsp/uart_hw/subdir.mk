...
C_SRCS += \
../User/board/MCU_bsp/uart_hw/uart_hw.c 

OBJS += \
./User/board/MCU_bsp/uart_hw/uart_hw.o 

C_DEPS += \
./User/board/MCU_bsp/uart_hw/uart_hw.d 


# Each subdirectory must supply rules for building sources it contributes
User/board/MCU_bsp/uart_hw/%.o: ../User/board/MCU_bsp/uart_hw/%.c
	@echo 'Building file: $<'
